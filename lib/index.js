...
exports.util = Utils;
exports.zookeeper = require('node-zookeeper-client');
...
exports.provider = {
    ThriftServerProviderFactory: require('../lib/provider/ThriftServerProviderFactory'),
    ZookeeperThriftServerProviderFactory: require('../lib/provider/ZookeeperThriftServerProviderFactory')
};
exports.logger = require('./util/LogUtils');