...
module.exports = class AbstractLoadBalance extends require('./LoadBalance'){
    static selector(invokers, method) {
        if (invokers == null || invokers.size <= 0)
            return null;
        if (invokers.size == 1)
            return [...invokers][0];
        return AbstractLoadBalance.doSelect(invokers, method);
    }
    ...
    static calculateWarmupWeight(uptime, warmup, weight) {
