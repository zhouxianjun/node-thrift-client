...
module.exports = class AbstractInvoker extends require('./Invoker') {
    ...
    get address(){return prop.address;}

    get host(){return prop.host;}

    get port(){return prop.port;}

    get weight(){return prop.weight;}

    get startTime(){return prop.startTime;}

    get warmup(){return prop.warmup;}

    get interface(){return prop.interfaceClass;}

    get interfaceName(){return prop.interfaceName;}
};